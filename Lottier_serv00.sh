...
USERNAME=$(whoami)
HOSTNAME=$(hostname)
export UUID=${UUID:-'8d251237-24c4-45ae-be34-f1a570815ec8'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'serv7.gab.us.kg'}   
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiZDA1ODQ1MzgzNTNkMzYyNjJlNTcwZWQ4NmMxZDkwYTYiLCJ0IjoiZDE1YTMwNjQtNjljMC00NjFhLWIyOTMtOTM0MWJlNDk5MTQ3IiwicyI6Ik0yVm1NMkV3TURrdE56ZG1OaTAwWW1NMkxUbGhaVGt0TUdWa05URXpNakptWmpnMCJ9'} 
...
download_singbox() {
  ...
  if [ "$ARCH" == "arm" ] || [ "$ARCH" == "arm64" ] || [ "$ARCH" == "aarch64" ]; then
      ...
      FILE_INFO=("https://github.com/ansoncloud8/am-serv00-vmess/releases/download/1.0.0/amd64-web web" "https://github.com/ansoncloud8/am-serv00-vmess/releases/download/1.0.0/amd64-bot bot" "https://github.com/ansoncloud8/am-serv00-vmess/releases/download/1.0.0/arm64-npm npm")
  else
