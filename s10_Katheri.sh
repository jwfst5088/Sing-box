...
USERNAME=$(whoami)
HOSTNAME=$(hostname)
export UUID=${UUID:-'38ff799d-b03a-4b02-b13a-7dfd8fe81bbb'}
export NEZHA_SERVER=${NEZHA_SERVER:-''} 
export NEZHA_PORT=${NEZHA_PORT:-'5555'}     
export NEZHA_KEY=${NEZHA_KEY:-''} 
export ARGO_DOMAIN=${ARGO_DOMAIN:-'katheri.quo.us.kg'}   
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiZDA1ODQ1MzgzNTNkMzYyNjJlNTcwZWQ4NmMxZDkwYTYiLCJ0IjoiYmM2M2ZhYTgtZjgzOS00ZTdmLTg5NmYtZjFiMWJhNmM0Yzg1IiwicyI6Ik9UUXhNbVZrWkdNdFpqazJPQzAwTmpnMExXRTBaR010TmpNMU5ERXdaRFUzT0ROaCJ9'}
export VMESS_PORT=${VMESS_PORT:-'11130'}
export TUIC_PORT=${TUIC_PORT:-'11131'}
export HY2_PORT=${HY2_PORT:-'11132'}
